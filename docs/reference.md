...
- `Export Templates` — Select one or more templates and save their signed Rewst export bundle to the default export directory or an existing local folder
- `Export Forms` — Select one or more forms and save their signed Rewst export bundle to the default export directory or an existing local folder
...
| `rewst-buddy.mcp.exportRoots`                    | `array`   | `[]`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Additional absolute directories approved for workflow, template, and form export output. Downloads, active workspace folders, and the current Git checkout are approved automatically. Export paths stay within the approved directories.                                                                                                                                                                                                                                                             |
| `rewst-buddy.mcp.exportDefaultDir`               | `string`  | `""`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Default directory the workflow, template, and form export tools save to when no `outputPath` is given. Must be an absolute path; it is created when missing and automatically approved. Empty uses the cross-OS default (`<home>/Downloads/Rewst Exports`).                                                                                                                                                                                                                                           |
