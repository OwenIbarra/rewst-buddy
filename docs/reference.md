...
- `Generate MCP Client Config` — Print/copy the MCP client config that points at the bundled credential-free bridge (see [MCP Server](features.md#mcp-server-external-ai-clients))
...
| `rewst-buddy.mcp.enable`              | `boolean` | `false`                                                     | Expose your authenticated Rewst sessions to external MCP clients (Claude Desktop, Claude Code, Cursor) through a local, credential-free bridge. Off by default. See [MCP Server](features.md#mcp-server-external-ai-clients).                                                                                                                                                                                                                                                                |
| `rewst-buddy.mcp.enableWriteTools`    | `boolean` | `false`                                                     | Allow MCP tools that change Rewst data. Even when enabled, each change still requires your per-resource approval inside VS Code. Read-only tools work without it.                                                                                                                                                                                                                                                                                                                            |
| `rewst-buddy.mcp.enabledTools`        | `array`   | `[]`                                                        | Allowlist of MCP capability names to expose. Empty means all enabled read tools; set names to restrict the surface (e.g. `["list_orgs", "list_templates"]`).                                                                                                                                                                                                                                                                                                                                 |
