...
| `rewst-buddy.mcp.exportRoots`                    | `array`   | `[]`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Additional absolute directories approved for `buddy_export_workflows` local output. Downloads, active workspace folders, and the current Git checkout are approved automatically. Paths are resolved canonically to prevent traversal and symlink escapes.                                                                                                                                                                                                                                            |
